            ...
            <DataTable>
              <DataTable.Header
                style={{
                  ...
                  borderTopRightRadius: 5,marginTop:22
                }}>
                ...
                ? data.filter(searched(keyword)).map((single, i) => (
                    <DataTable.Row
                      ...
                      <DataTable.Cell style={{flex: 1}}>
                        <Text style={styles.fontvalue}>
                          {single.ReverseDeliveries}
                        </Text>
                      </DataTable.Cell>
                      <DataTable.Cell style={{flex: 1, marginRight: -55}}>
                        <Text style={styles.fontvalue}>{numScanned}</Text>
                      </DataTable.Cell>
                      {/* <ArrowForwardIcon
                        style={{color: '#004aad', marginTop: 8}}
                      /> */}
                    </DataTable.Row>
                  ))
                : null}
